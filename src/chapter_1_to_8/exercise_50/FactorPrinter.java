 ...
 *
 * If number is < first, the method should print "Invalid Value".
 *
 ...
 *
 * * printFactors(6); → should print first 2 3 6
 *
 * * printFactors(32); → should print first 2 4 8 16 32
 *
 * * printFactors(10); → should print first 2 5 10
 *
 * * printFactors(-first); → should print "Invalid Value" since number is < first
 *
 *
